...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display': ['clamp(3rem, 10vw, 8rem)', { lineHeight: '0.95', fontWeight: '700' }],
        'heading': ['clamp(2rem, 6vw, 4rem)', { lineHeight: '1.1', fontWeight: '700' }],
        'subheading': ['clamp(1.5rem, 4vw, 2.5rem)', { lineHeight: '1.2', fontWeight: '600' }],
      },
      backgroundImage: {
